...
static void naive_matmul(int64_t M, int64_t N, int64_t K, const float* A, const float* B,
                         float* C) {
...
static int verify_result(int64_t M, int64_t N, const float* got, const float* expected) {
...
static double benchmark_sgemm(int64_t M, int64_t N, int64_t K, int iterations, int warmup) {
