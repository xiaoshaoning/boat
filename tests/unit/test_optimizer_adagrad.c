// test_optimizer_adagrad.c - Adagrad optimizer unit tests
...
int main() {
    printf("Starting Adagrad optimizer tests...\n");
    printf("Testing Adagrad optimizer...\n");

    // Test 1: Adagrad optimizer creation
    {
        boat_optimizer_t* optimizer = boat_adagrad_optimizer_create(0.001f, 1e-8f);
        assert(optimizer != NULL);

        // Test that invalid parameters are rejected
        boat_optimizer_t* invalid1 = boat_adagrad_optimizer_create(0.0f, 1e-8f);
        assert(invalid1 == NULL);

        boat_optimizer_t* invalid2 = boat_adagrad_optimizer_create(0.001f, 0.0f);
        assert(invalid2 == NULL);

        boat_optimizer_t* invalid3 = boat_adagrad_optimizer_create(0.001f, -1e-8f);
        assert(invalid3 == NULL);

        boat_optimizer_free(optimizer);
        printf("  Test 1 passed: Adagrad optimizer creation\n");
    }
    ...
    {
        boat_optimizer_t* optimizer = boat_adagrad_optimizer_create(0.01f, 1e-8f);
        assert(optimizer != NULL);
        ...
        // Adagrad has adaptive learning rate, so hard to predict exact value
    ...
    {
        boat_optimizer_t* optimizer = boat_adagrad_optimizer_create(0.05f, 1e-8f);
        assert(optimizer != NULL);
    ...
    printf("All Adagrad optimizer tests passed!\n");
    return 0;
}