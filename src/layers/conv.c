...
BOAT_NOINLINE BOAT_API boat_tensor_t* BOAT_CALL boat_conv_layer_get_weight(boat_conv_layer_t* layer) {
    return layer ? layer->weight : NULL;
}

BOAT_NOINLINE BOAT_API boat_tensor_t* BOAT_CALL boat_conv_layer_get_bias(boat_conv_layer_t* layer) {
...
BOAT_NOINLINE BOAT_API boat_tensor_t* BOAT_CALL boat_conv_layer_get_grad_bias(boat_conv_layer_t* layer) {
