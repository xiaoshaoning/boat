...
boat_onnxruntime_session_t* boat_onnxruntime_create(const char* model_path,
...
const char* boat_onnxruntime_input_name(const boat_onnxruntime_session_t* session, size_t index);

// Get the name of the i-th output (returns pointer to internal string,
// valid until session is freed).
const char* boat_onnxruntime_output_name(const boat_onnxruntime_session_t* session, size_t index);
...
boat_tensor_t* boat_onnxruntime_run(boat_onnxruntime_session_t* session,
...
boat_tensor_t** boat_onnxruntime_run_multi(boat_onnxruntime_session_t* session,
                                           boat_tensor_t* const* inputs, const char** input_names,
