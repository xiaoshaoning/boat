...
BOAT_API void boat_cuda_sub_f32(const float* a, const float* b, float* c, size_t n);
BOAT_API void boat_cuda_mul_f32(const float* a, const float* b, float* c, size_t n);
BOAT_API void boat_cuda_div_f32(const float* a, const float* b, float* c, size_t n);
BOAT_API void boat_cuda_relu_f32(const float* a, float* c, size_t n);
BOAT_API void boat_cuda_relu_backward_f32(const float* x, const float* dy, float* dx, size_t n);
BOAT_API void boat_cuda_sigmoid_f32(const float* a, float* c, size_t n);
BOAT_API void boat_cuda_tanh_f32(const float* a, float* c, size_t n);
BOAT_API void boat_cuda_silu_f32(const float* a, float* c, size_t n);
BOAT_API void boat_cuda_add_scalar_f32(const float* a, float scalar, float* c, size_t n);
BOAT_API void boat_cuda_mul_scalar_f32(const float* a, float scalar, float* c, size_t n);

// Additional math kernels
void boat_cuda_exp_f32(const float* a, float* c, size_t n);
BOAT_API void boat_cuda_log_f32(const float* a, float* c, size_t n);
BOAT_API void boat_cuda_sqrt_f32(const float* a, float* c, size_t n);
BOAT_API void boat_cuda_rsqrt_f32(const float* a, float* c, size_t n);
BOAT_API void boat_cuda_neg_f32(const float* a, float* c, size_t n);
BOAT_API void boat_cuda_abs_f32(const float* a, float* c, size_t n);
BOAT_API void boat_cuda_mod_f32(const float* a, const float* b, float* c, size_t n);
BOAT_API void boat_cuda_sub_scalar_f32(const float* a, float scalar, float* c, size_t n);
BOAT_API void boat_cuda_div_scalar_f32(const float* a, float scalar, float* c, size_t n);
BOAT_API void boat_cuda_fill_f32(float* c, float val, size_t n);
BOAT_API void boat_cuda_scale_f32(float* c, float scalar, size_t n);
BOAT_API void boat_cuda_clamp_f32(const float* a, float* c, float lo, float hi, size_t n);
...
BOAT_API void boat_cuda_bf16_to_fp32(const void* in, float* out, int n);
...
BOAT_API void boat_cuda_fp8_to_fp32(const void* in, float* out, int n);

// ---------------------------------------------------------------------------
// FP8 element-wise kernels (void* for FP8 data, C-compatible)
// ---------------------------------------------------------------------------
void boat_cuda_fp8_add(const void* a, const void* b, void* out, int n);
BOAT_API void boat_cuda_fp8_mul(const void* a, const void* b, void* out, int n);
BOAT_API void boat_cuda_fp8_relu(const void* a, void* out, int n);
BOAT_API void boat_cuda_fp8_residual_add(void* y, const void* x, int n);
